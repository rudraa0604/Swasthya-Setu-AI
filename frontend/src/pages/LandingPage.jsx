    ...
    <div style={{ background: 'transparent', color: '#f8fafc', minHeight: '100vh', fontFamily: 'var(--font-sans)', position: 'relative' }}>
      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.75rem)', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.02em', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
              {t.capabilitiesTitle}
            </h2>
            <p style={{ color: '#cbd5e1', maxWidth: '650px', margin: '0.75rem auto 0 auto', fontSize: '1rem', textShadow: '0 1px 8px rgba(0,0,0,0.5)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem' }}>
            {features.map((feat, idx) => {
              ...
              return (
                ...
                >
                  <div>
                    <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: feat.bg, border: `1px solid ${feat.color}40`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.25rem', backdropFilter: 'blur(6px)' }}>
                      <Icon size={24} color={feat.color} />
                    </div>

                    <h3 style={{ fontSize: '1.15rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.75rem', textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
                      {feat.title}
                    </h3>
      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.75rem)', fontWeight: 800, color: '#ffffff', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
              {t.rolesTitle}
            </h2>
            <p style={{ color: '#cbd5e1', maxWidth: '650px', margin: '0.75rem auto 0 auto', fontSize: '1rem', textShadow: '0 1px 8px rgba(0,0,0,0.5)' }}>
              {t.rolesSubtitle}
                ...
                >
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                      <div style={{ background: `${st.color}30`, border: `1px solid ${st.color}50`, padding: '0.5rem', borderRadius: '8px' }}>
                    ...
                    <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#ffffff', textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>{st.title}</h3>
          ...
          <div style={{ textAlign: 'center', marginTop: '3.5rem' }}>
            ...
            >
              {t.masterPortalBtn} <ArrowRight size={20} />
            </button>
          </div>
        </div>
      </section>
